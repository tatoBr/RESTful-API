...
router.post( '/', upload.single('imagem'), controller.criar_produto.bind( controller ));
router.get( '/', controller.listar_produtos.bind( controller ) );
router.get( '/:id', controller.buscar_produto.bind( controller ) );
router.patch( '/:id', controller.atualizar_produto.bind( controller )  );
router.delete( '/:id', controller.apagar_produto.bind( controller ) );
